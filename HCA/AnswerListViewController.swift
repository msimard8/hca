...
class AnswerListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        answersTableView?.register(UINib(nibName: "AnswerListQuestionTableViewCell", bundle: nil),
                                   forCellReuseIdentifier: AnswerListQuestionTableViewCell.identifier)
        answersTableView?.register(UINib(nibName: "AnswerListAnswerTableViewCell", bundle: nil),
                                   forCellReuseIdentifier: AnswerListAnswerTableViewCell.identifier)
